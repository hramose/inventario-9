...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-11-2016 a las 04:31:42
...
(1, 'Telefonos', 'Todo en telefonos', 1),
(2, 'Computadoras', 'todo en computadoras', 1),
(4, 'Hardware', 'Todo en hardware', 1),
(5, 'Cables', 'Todo en cables', 1);
...
CREATE TABLE `ingreso` (
  ...
  `serie_comprobante` varchar(8) DEFAULT NULL,
